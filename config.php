...
<nav class="navbar navbar-expand-lg navbar-info bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        <button class="btn btn-outline-success me-2" type="submit">Upgrade Account</button>
...
$config = mysqli_connect($hostname,$username,$password,$dbname);
		...
		else
		{
			...
			echo "<div>";
			echo "Welcome,"."<strong>&nbsp;".gethostname()."</strong>,&nbsp;&nbsp;". "Database Connection Established Successfully";
			echo "</div>";
			echo "</div>";
